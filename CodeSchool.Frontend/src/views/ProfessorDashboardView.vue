        ...
        <main id="conteudo-principal" class="content">
            ...
            <section class="turmas">
                ...
                <div v-else class="turmas-grid">
                    <div v-for="turma in turmas" :key="turma.id" class="turma-card" @click="verTurma(turma.id)">
            ...
            <div class="modal" @click.stop>
                ...
                <form @submit.prevent="criarTurma">
                    <div class="form-group">
                        ...
                        <input id="nome-turma" v-model="nomeTurma" type="text" placeholder="Ex: 6º Ano A" required />
                    </div>
