      ...
      <div class="menu-opcoes">
        ...
        <div class="opcao">
          <label class="switch">
            <input 
              type="checkbox" 
              :checked="accessibilityStore.altoContraste"
        ...
        <div class="opcao">
          ...
          <div class="fonte-controles">
            <button 
              @click="accessibilityStore.setTamanhoFonte('pequeno')"
              :class="{ ativo: accessibilityStore.tamanhFonte === 'pequeno' }"
              aria-label="Fonte pequena"
            >
              A
            </button>
            <button 
              @click="accessibilityStore.setTamanhoFonte('normal')"
              :class="{ ativo: accessibilityStore.tamanhFonte === 'normal' }"
            ...
            <button 
              @click="accessibilityStore.setTamanhoFonte('grande')"
              :class="{ ativo: accessibilityStore.tamanhFonte === 'grande' }"
        ...
        <div class="opcao">
          <label class="switch">
            <input 
              type="checkbox" 
              :checked="accessibilityStore.narracao"
              @change="accessibilityStore.toggleNarracao()"
              aria-label="Ativar narração de texto"
            />
            <span class="slider"></span>
          </label>
        ...
        <div class="opcao">
          <label class="switch">
            <input 
              type="checkbox" 
              :checked="accessibilityStore.reducaoMovimento"
